...
/**
 * A Java program to find the missing number in an array containing distinct numbers 
 * from 0 to n, with one number missing.
 * 
 * This class demonstrates four approaches:
 ...
 * - Better: O(n) — two linear passes.
 * - Optimal_1 (Sum Formula): O(n) — single linear pass.
 * - Optimal_2 (XOR): O(n) — single linear pass.
 *
 * Space Complexity:
 * - Brute Force: O(1) — no extra space.
 * - Better: O(n) — extra space for frequency array.
 * - Optimal_1: O(1) — no extra space.
...
public class MissingNumber_3 {
     ...
     * 
     * Iterates through all numbers from 0 to n and for each number,
     * checks whether it exists in the given array.
     *
     * @param nums The input array containing distinct numbers from 0 to n, except one.
     ...
     * 
     * Marks each encountered number in a frequency array and identifies
     * the missing one by checking the unmarked index.
     *
     * @param nums The input array containing distinct numbers from 0 to n, except one.
     * @return The missing number in the array, or -1 if no number is missing.
     */
     ...
     * 
     * Calculates the expected total sum from 0 to n and subtracts
     * the sum of given numbers to identify the missing number.
     *
     * @param nums The input array containing distinct numbers from 0 to n, except one.
     ...
     * and all elements in the array to cancel out existing values and identify the missing one.
     *
     * @param nums The input array containing distinct numbers from 0 to n, except one.
     * @return The missing number.
     */
